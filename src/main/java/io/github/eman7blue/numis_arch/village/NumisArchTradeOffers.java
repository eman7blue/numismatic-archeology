...
public class NumisArchTradeOffers {
    ...
    public static void registerTrades() {
        TradeOfferHelper.registerVillagerOffers(NumisArchProfession.ARCHEOLOGIST, 1, factories -> {
            factories.add(new TradeOffers.BuyItemFactory(Items.CHARCOAL, 10, 16, 2));
        ...
        TradeOfferHelper.registerVillagerOffers(NumisArchProfession.ARCHEOLOGIST, 2, factories -> {
            factories.add(new TradeOffers.BuyItemFactory(Items.TERRACOTTA, 32, 12, 5));
        ...
        TradeOfferHelper.registerVillagerOffers(NumisArchProfession.ARCHEOLOGIST, 3, factories -> {
            factories.add(new TradeOffers.BuyItemFactory(Items.ANGLER_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.ARCHER_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.ARMS_UP_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.BLADE_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.BREWER_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.BURN_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.DANGER_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.EXPLORER_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.FRIEND_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.HEART_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.HEARTBREAK_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.HOWL_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.MINER_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.MOURNER_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.PLENTY_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.PRIZE_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.SKULL_POTTERY_SHERD, 1, 12, 20));
            factories.add(new TradeOffers.BuyItemFactory(Items.SNORT_POTTERY_SHERD, 1, 12, 20));
        });
        ...
        TradeOfferHelper.registerVillagerOffers(NumisArchProfession.ARCHEOLOGIST, 5, factories -> {
            ...
            factories.add(new TradeOffers.ProcessItemFactory(Blocks.SAND, 16, 43, Items.SUSPICIOUS_SAND, 1, 3, 30, 0.05F));
            factories.add(new TradeOffers.ProcessItemFactory(Blocks.GRAVEL, 16, 43, Items.SUSPICIOUS_GRAVEL, 1, 3, 30, 0.05F));
            factories.add(new TradeOffers.ProcessItemFactory(Blocks.RED_SAND, 16, 43, NumisArchItems.SUSPICIOUS_RED_SAND, 1, 3, 30, 0.05F));
        });
    }
}
