...
public class NumismaticDeskBlock extends BlockWithEntity {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof NumismaticDeskBlockEntity) {
                ItemScatterer.spawn(world, pos, (NumismaticDeskBlockEntity) blockEntity);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new NumismaticDeskBlockEntity(pos, state);
    }
